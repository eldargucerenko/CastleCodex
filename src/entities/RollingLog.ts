...
export class RollingLog {
  ...
  constructor(
    ...
    this.body = scene.add.rectangle(78, 178, 76, 20, 0x7c3f1d).setStrokeStyle(3, 0x3f1f0f).setDepth(45);
    this.body.setAngle(-8);
    this.body.setInteractive({ useHandCursor: true });
    this.label = scene.add.text(78, 151, 'LOG', { color: '#3f1f0f', fontSize: '13px', fontStyle: 'bold' }).setOrigin(0.5).setDepth(46);
